...
const Home = () => {
  ...
  //     const response = await fetch("https://cluster-server.onrender.com/posts/create-post", {
  //       method: "POST",
  //       headers: {
    ...
    const fetchPosts = async () => {
      try {
        ...
        const response = await axios.post(
          // "https://cluster-server.onrender.com/posts/"
          "https://cluster-server.onrender.com/posts/"
        );
  ...
  const handlePostSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(
        "https://cluster-server.onrender.com/posts/create-post",
        // "https://cluster-server.onrender.com/posts/create-post",
        postData
      );
  ...
  //     const response = await axios.post('https://cluster-server.onrender.com/posts/create-post', postData);
